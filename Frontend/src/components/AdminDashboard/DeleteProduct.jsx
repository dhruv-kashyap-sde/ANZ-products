    ...
    try {
      ...
      await Promise.all(
        selectedProducts.map((productId) =>
          axios.delete(`${URL}/products/${productId}`)
        )
      );
      setAllProducts(
        allProducts.filter((product) => !selectedProducts.includes(product._id))
      );
      setSelectedProducts([]);
      ...
      {showConfirmDialog && (
        <div className="confirm-dialog-overlay">
          <div className="confirm-dialog">
            ...
            <button className="popup-yes" onClick={handleDelete}>
              Yes
            </button>
            <button className="popup-no" onClick={handleCloseDialog}>
              No
            </button>
          </div>
        </div>
